...
import com.taotao.manager.service.ProperttiesService;
...
public class PicUploadController {
	...
	//produces设置该controller返回的数据类型，借助MediaType类型设定为text/plain类型，其实就是把json格式又变成了字符串。历史遗留问题
	...
	private String getFilePath(String sourceFileName) {
		...
		// yyyy/MM/dd
		//再将baseFolder根据文件上传的日期再生成日期目录，file.separator分离目录，分层建立 ：basefolder/年目录/月目录/日目录
